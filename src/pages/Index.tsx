          ...
          <div className="space-y-12 animate-bounce-in">
            <section className="text-center space-y-6">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Попробуй свои силы в трёх мини-играх и приходи на турнир от
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      18 декабря в 17:30, Дискозал Дома Культуры МЭИ. Следи за
                      новостями в нашей группе ВКонтакте!
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    18 декабря в 17:30, Дискозал Дома Культуры МЭИ. Вечер
                    компьютерных игр на приставке и настольных игр от
                    студенческого энергетического отряда "Электросила"
                  </p>
                </div>
              </div>
